...
// in send_money_app/test/domain/usecases/get_transactions_test.dart.
...
import 'package:send_money_app/core/error/failures.dart' as _i5;
import 'package:send_money_app/domain/entities/transaction.dart' as _i6;
...
class MockTransactionRepository extends _i1.Mock
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.Transaction>> sendMoney(
          double? amount) =>
      (super.noSuchMethod(
        Invocation.method(
          #sendMoney,
